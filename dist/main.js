...
/* harmony import */ var _listeners__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./listeners */ "./src/modules/listeners.js");
...
const dom = (() => {
  ...
  function _showTask(task) {
    ...
    _listeners__WEBPACK_IMPORTED_MODULE_2__["default"].initToggleTask(checkbox);
    //title
    ...
    _listeners__WEBPACK_IMPORTED_MODULE_2__["default"].initEditTask(editTask);
    //delete button
    const deleteTask = document.createElement("button");
    deleteTask.classList.add("delete-task", "fa-solid", "fa-trash-can");
    _listeners__WEBPACK_IMPORTED_MODULE_2__["default"].initRemoveTask(deleteTask);
...
Use 'selected,' 'disabled', 'hidden' attributes in option tag */
  ...
  function refreshSidebarProjects(projects) {
    ...
    projects.forEach((project) => {
      ...
      _listeners__WEBPACK_IMPORTED_MODULE_2__["default"].initSidebarProject(liProject);
    });
  }
...
const listeners = (() => {
  ...
  function initSidebarProject(li) {
    li.addEventListener("click", (e) => {
      ...
      _dom__WEBPACK_IMPORTED_MODULE_0__["default"].showProject(projects[indexOfClickedListItem]);
    });
  }
...
const storage = (() => {
  ...
  function createDefaultProject() {
    const defaultProject = new _project__WEBPACK_IMPORTED_MODULE_1__.Project("Default");
  ...
  function getTask() {
    ...
    const returnedTask = new _task__WEBPACK_IMPORTED_MODULE_0__.Task(
      title,
      description,
      dueDate,
      priority,
...
class Task {
  ...
  set dueDate(newDueDate) {
    ...
    if (newDueDate.charAt(2) == "/") {
      ...
      newDueDate = (0,date_fns__WEBPACK_IMPORTED_MODULE_0__["default"])(date, "MM/dd/yyyy");
    }
...
_modules_storage__WEBPACK_IMPORTED_MODULE_4__["default"].createProjects();

btnTest.addEventListener("click", () => {
  _modules_storage__WEBPACK_IMPORTED_MODULE_4__["default"].clear();
});
